...
INPUT_MODEL="/workspace/results/your_data_train/checkpoint_epoch_100.tlt"

# ★出力: ONNXファイルの保存先ディレクトリ
EXPORT_DIR="/workspace/results/export"

# ★出力: ONNXファイルの名前
ONNX_FILENAME="pp_epoch100.onnx"
...
docker run --rm --gpus all \
    ...
    python3 /workspace/pointpillars/scripts/export.py \
        ...
        \
        dataset.data_path="/workspace/data/ReidPillar-HF" \
